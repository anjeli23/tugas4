...
<body>
            ...
            <nav class="navbar navbar-default">
                ...
                <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                    <ul class="nav navbar-nav">
                        ...
                        <!-- Mega Menu -->
                        <li class="dropdown">
                            <a href="{{ url('product') }}/" class="" data-toggle="">Product<b
                                    class=""></b></a>
    ...
    <ul id="demo1">
        <li>
            <img src="{{ url('public') }}/images/11.jpg" alt="" />
        ...
        <li>
            <img src="{{ url('public') }}/images/22.jpg" alt="" />
            <div class="slide-desc">
        ...
        <li>
            <img src="{{ url('public') }}/images/44.jpg" alt="" />
            <div class="slide-desc">
                <h3>Whole Spices Products Are Now On Line With Us</h3>
            </div>
        </li>
            ...
            <div class="w3_footer_grids">
                <div class="col-md-3 w3_footer_grid">
                    ...
                    <ul class="info">
                        ...
                        <li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="{{ url('product') }}/">Product
                            </a></li>
